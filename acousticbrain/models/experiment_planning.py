...
class ExperimentSelectionReason(Enum):
    ...
    SBIR_FREQUENCY_MISMATCH_TOO_HIGH = "SBIR_FREQUENCY_MISMATCH_TOO_HIGH"
    SBIR_PREDICTION_UNCERTAINTY_TOO_HIGH = (
        "SBIR_PREDICTION_UNCERTAINTY_TOO_HIGH"
    )
    NON_REVERSIBLE = "NON_REVERSIBLE"
    USER_DEFERRED = "USER_DEFERRED"
    CAUSAL_DISCRIMINATION_COMPLETED = "CAUSAL_DISCRIMINATION_COMPLETED"
    ACQUISITION_PROTOCOL_INCOMPLETE = "ACQUISITION_PROTOCOL_INCOMPLETE"
